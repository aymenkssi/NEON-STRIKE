...
export type MissionDef = { id: string; text: string; metric: Metric; target: number; reward: number; minLevel: number };

export const MISSION_POOL: MissionDef[] = [
  { id: "kills", text: "Élimine 40 zombies", metric: "kills", target: 40, reward: 60, minLevel: 1 },
  { id: "headshots", text: "Réussis 15 tirs à la tête", metric: "headshots", target: 15, reward: 60, minLevel: 1 },
  { id: "levels", text: "Termine 2 niveaux", metric: "levels", target: 2, reward: 80, minLevel: 1 },
  { id: "boss", text: "Élimine un boss", metric: "bosses", target: 1, reward: 70, minLevel: 1 },
  { id: "combo", text: "Réalise un combo ×3", metric: "bestCombo", target: 3, reward: 70, minLevel: 1 },
  { id: "powerups", text: "Ramasse 3 bonus", metric: "powerups", target: 3, reward: 60, minLevel: 1 },
  { id: "stars", text: "Termine un niveau avec 3 étoiles", metric: "threeStars", target: 1, reward: 90, minLevel: 1 },
  { id: "runners", text: "Élimine 10 coureurs", metric: "runner", target: 10, reward: 70, minLevel: 3 },
  { id: "tanks", text: "Élimine 4 blindés", metric: "tank", target: 4, reward: 80, minLevel: 5 },
  { id: "blast", text: "Tue 5 zombies avec des explosions", metric: "explosionKills", target: 5, reward: 90, minLevel: 7 },
];
...
export const ACHIEVEMENTS: AchievementDef[] = [
  { id: "first_blood", title: "Premier sang", text: "Élimine ton premier zombie", icon: "water", reward: 20, target: 1, value: (p) => p.stats.kills },
  { id: "kills_100", title: "Nettoyeur", text: "Élimine 100 zombies", icon: "skull", reward: 100, target: 100, value: (p) => p.stats.kills },
  { id: "kills_1000", title: "Exterminateur", text: "Élimine 1 000 zombies", icon: "skull-crossbones", reward: 500, target: 1000, value: (p) => p.stats.kills },
  { id: "heads_50", title: "Tireur d'élite", text: "Réussis 50 tirs à la tête", icon: "target", reward: 100, target: 50, value: (p) => p.stats.headshots },
  { id: "heads_500", title: "Œil de lynx", text: "Réussis 500 tirs à la tête", icon: "crosshairs-gps", reward: 400, target: 500, value: (p) => p.stats.headshots },
  { id: "boss_1", title: "Tueur de géant", text: "Élimine ton premier boss", icon: "sword-cross", reward: 100, target: 1, value: (p) => p.stats.bosses },
  { id: "boss_10", title: "Chasseur de boss", text: "Élimine 10 boss", icon: "crown", reward: 300, target: 10, value: (p) => p.stats.bosses },
  { id: "combo_5", title: "Carnage", text: "Réalise un combo ×5", icon: "lightning-bolt", reward: 150, target: 5, value: (p) => p.stats.bestCombo },
  { id: "combo_10", title: "Déchaîné", text: "Réalise un combo ×10", icon: "flash", reward: 400, target: 10, value: (p) => p.stats.bestCombo },
  { id: "blast_25", title: "Artificier", text: "Tue 25 zombies avec des explosions", icon: "bomb", reward: 200, target: 25, value: (p) => p.stats.explosionKills },
  { id: "sector_2", title: "Explorateur", text: "Débloque le secteur 2", icon: "map-marker", reward: 150, target: 6, value: (p) => p.unlockedLevel },
  { id: "sector_4", title: "Vétéran", text: "Débloque le secteur 4", icon: "map-marker-star", reward: 300, target: 16, value: (p) => p.unlockedLevel },
  { id: "sector_6", title: "Survivant ultime", text: "Débloque le secteur 6", icon: "shield-star", reward: 500, target: 26, value: (p) => p.unlockedLevel },
  { id: "campaign", title: "Légende", text: "Termine le niveau 30", icon: "trophy", reward: 1000, target: 1, value: (p) => ((p.stars["30"] ?? 0) > 0 ? 1 : 0) },
  { id: "stars_30", title: "Constellation", text: "Obtiens 30 étoiles", icon: "star-shooting", reward: 200, target: 30, value: totalStars },
  { id: "stars_90", title: "Perfectionniste", text: "Obtiens les 90 étoiles", icon: "star-circle", reward: 1000, target: 90, value: totalStars },
  { id: "arsenal_max", title: "Armurier", text: "Monte une amélioration au maximum", icon: "wrench", reward: 200, target: 5, value: (p) => Math.max(...Object.values(p.upgrades)) },
];
